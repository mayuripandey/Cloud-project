...
st=commands.getstatusoutput("sudo mkdir -p /copy".format(serverPassword,serverIp))
if(st[0]==0):
...
print st
st=commands.getstatusoutput("sshpass -p {} ssh -o StrictHostKeyChecking=no -l root {} 'systemctl restart nfs'".format(serverPassword,serverIp))
if(st[0]==0):
         print "nfs"
else:
   print "not nfs"
